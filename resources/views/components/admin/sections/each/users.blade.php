<section
    x-show="(openSidebar && isSideOption == 'users')"
>
    ...
    <div class="pl-4 mt-3">
        ...
        <div class="flex flex-col space-y-4 mt-6">
            ...
            <a href="{{ route('solicitation.index') }}" class="bg-gray-800 sm:w-56 w-48 py-3 px-4 rounded-lg flex items-center hover:bg-gray-800/50">
                ...
                <h2 class="text-xs text-white font-bold ml-2">Lista de usuários</h2>
            </a>
            ...
            <a href="{{ route('solicitation.index') }}" class="bg-gray-800 sm:w-56 w-48 py-3 px-4 rounded-lg flex items-center hover:bg-gray-800/50">
                ...
                <h2 class="text-xs text-white font-bold ml-2">Usuários Online</h2>
            </a>
