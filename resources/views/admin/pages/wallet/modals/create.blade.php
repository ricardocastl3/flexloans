<div
    ...
    <div
        ...
        @click.outside="openCreateCard=false">
        ...
        <form
            ...
            <div class="flex flex-col space-y-4">
                ...
                <input name="name" type="text" placeholder="Ex.: Conta Transporte..."
            ...
            <div class="flex flex-col space-y-4">
                ...
                <input name="balance" type="text" placeholder="Ex.: 20000..."
                       class="p-2 text-white font-bold text-xs border-gray-900 border-2 border-b-violet-800 bg-gray-900 rounded-lg "/>
            </div>
