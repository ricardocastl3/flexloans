        ...
        <div class="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 mt-8 gap-4">
                    ...
                    <div x-data="{open:false}">
                        <div class="absolute top-0 right-0 m-4" @click.outside="open=false">
                            ...
                            <div x-show="open"
                                ...
                                <a href="#" class="text-red-600 text-xs font-bold hover:bg-gray-800 flex items-center rounded-lg p-2 w-28">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-4 h-4 mr-2">
            ...
            <div x-data="{openCreateCard:false}">
                <div class="flex items-center justify-center border border-violet-500 rounded-lg p-8">
                    <button class="transition-colors hover:bg-violet-800 text-violet-800 hover:text-white flex items-center justify-center p-6 rounded-full border border-violet-800"
