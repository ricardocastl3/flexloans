<x-admin-layout>
    ...
    <div class="">
        ...
        <div class="my-8">
            <h2 class="font-bold text-white text-xs my-4">FlexLoan, o seu Empréstimo flexível.</h2>
        ...
        class="grid md:grid-cols-3 grid-cols-1 gap-4 w-full">
            ...
            <div class="flex justify-between items-center border border-l-2 border-l-violet-600 border-b-2 border-b-violet-600 border-gray-700 rounded-lg bg-gray-900 py-6 px-6 w-full">
                <div>
                    ...
                    <h2 class="text-white my-3 font-bold text-base">@money($balance_t)</h2>
                </div>
                <div>
            ...
            <div class="flex justify-between items-center border border-l-2 border-l-violet-600 border-b-2 border-b-violet-600 border-gray-700 rounded-lg bg-gray-900 py-6 px-6 w-full">
                <div>
                    <h2 class="text-lg text-violet-500 font-bold">Empréstimo total</h2>
                    <h2 class="font-light text-violet-700">Este é o seu Empréstimo total</h2>
                    <h2 class="text-white my-3 font-bold text-base">@money($loan_t)</h2>
                </div>
                <div>
            ...
            <div class="flex justify-between items-center border border-l-2 border-l-violet-600 border-b-2 border-b-violet-600 border-gray-700 rounded-lg bg-gray-900 py-6 px-6 w-full">
                <div>
                    ...
                    <h2 class="text-white my-3 font-bold text-base">{{ $loan_count }}</h2>
                </div>
                <div>
        ...
        <div class="flex md:flex-row flex-col items-center md:space-x-4 space-x-0 my-12">
            <a href="{{ route('wallet.index') }}" class="hover:bg-gray-800 flex items-center text-xs font-bold text-white rounded-full p-4 bg-gray-900 border border-gray-700 border-b-2 border-b-violet-700">
            ...
            <a href="{{ route('solicitation.create') }}" class="hover:bg-gray-800 flex items-center text-xs font-bold text-white rounded-full p-4 bg-gray-900 border border-gray-700 border-b-2 border-b-violet-700">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-4 h-4 mr-2">
